...
the topic I have decided to enroll into McGill Physics Hackathon and encouraged my friends who are familiar with Unity Engine to join me.
...
<p align="center">
  <img src=https://github.com/konichuvak/konichuvak.github.io/blob/master/assets/boid_vision.png width="77%"/>
</p>
...
by boids is still looks jagged.
...
with our main simulation with 15 `Prey` boids and 3 `Predators`. After training for about an our or so this what we saw:
<p align="center">
...
You can check out other submissions on [devpost](https://mcgill-physics-hackathon-2019.devpost.com/submissions).    
